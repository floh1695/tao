...
export const book1 =
  ...
  .addChapter(
    Chapter.new(1, [
      ...
      blockquote([
        p('If the Tao is great, then the operating system is great.'),
        p('If the operating system is great, then the compiler is great.'),
        p('If the compiler is great, then the application is great.'),
        p('The user is pleased, and there is harmony in the world.'),
      ]),
...
Book.new(
  ...
  .addChapter(
    Chapter.new(1, [
      ...
      blockquote([
        p('Aware, like a fox crossing the water.'),
        p('Alert, like a general on the battlefield.'),
        p('Kind, like a hostess greeting her guests.'),
        p('Simple, like uncarved blocks of wood.'),
        p('Opaque, like black pools in darkened caves.'),
      ]),
